...
func (c *blockingCoordinator) AppendTools([]fantasy.AgentTool)                    {}
func (c *blockingCoordinator) BuildSessionAgent(context.Context, agent.AgentSpec) (agent.SessionAgent, error) {
	return nil, errors.New("not implemented in blockingCoordinator")
}
