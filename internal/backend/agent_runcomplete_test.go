...
func (c *errorCoordinator) AppendTools([]fantasy.AgentTool)                    {}
func (c *errorCoordinator) BuildSessionAgent(context.Context, agent.AgentSpec) (agent.SessionAgent, error) {
	return nil, errors.New("not implemented in errorCoordinator")
}
