...
func (c *scriptedCoordinator) AppendTools([]fantasy.AgentTool)                {}
func (c *scriptedCoordinator) BuildSessionAgent(context.Context, agent.AgentSpec) (agent.SessionAgent, error) {
	return nil, nil
}
